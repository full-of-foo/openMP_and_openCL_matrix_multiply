...
int main(int argc, char** argv) {
    ...
    fp = fopen("openCL_app/src/mm.cl","r");
    ...
    a_in  = clCreateBuffer(context, CL_MEM_READ_ONLY|CL_MEM_COPY_HOST_PTR,
                           sizeof(cl_float)*count, a_data, NULL);
    b_in  = clCreateBuffer(context, CL_MEM_READ_ONLY|CL_MEM_COPY_HOST_PTR,
                           sizeof(cl_float)*count, b_data, NULL);
